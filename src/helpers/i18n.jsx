...
vendors: {
  controls: {
    ...
    // NEW:
    vendorType: "Typ dostawcy",
    vendorTypePlaceholder: "Typ dostawcy",
  },
  ...
  chips: {
    ...
    // NEW (optional – only if you build chips like “Typ: …”):
    vendorType: "Typ",
  },
  ...
  modal: {
    ...
    // optional helper texts (only if you use them in component)
    autoNumberHelp: "Numer jest nadawany automatycznie.",
    choosePicture: "Wybierz zdjęcie",
    replacePicture: "Zmień zdjęcie",
    pictureHelp: "PNG/JPG/WebP • maks. ok. 2 MB • najlepiej kwadrat",
  },
...
vendors: {
  controls: {
    ...
    vendorTypePlaceholder: "Vendor type",
  },
  ...
  table: {
    ...
    // existing NEW (if used in EN UI too):
    owzSigned: "OWZ",
    frameworkAgreementSigned: "Framework",
  ...
  modal: {
    ...
    // optional helper texts
    autoNumberHelp: "Number is assigned automatically.",
    choosePicture: "Choose picture",
    replacePicture: "Replace picture",
    pictureHelp: "PNG/JPG/WebP • up to ~2 MB • square works best",
  },
