                        ...
                        <div className="p-3 rounded-2xl border border-slate-200 bg-slate-50">
                          <div className="grid grid-cols-1 gap-3 text-xs text-slate-700">
                            ...
                            <Section title="Header">
                              ...
                              <KV
                                label={L.kv.documentDate || "Document Date"}
                                icon={CalendarIcon}
                              >
                                {formatDate(d.documentDate, locale, "—")}
                              </KV>
                              ...
                              <KV
                                label={
                                  L.kv.validUntilTime || "Valid until time"
                                }
                                icon={CalendarIcon}
                              >
                                {d.validUntilTime || "—"}
                            ...
                            <Section title={L.shipment}>
                              ...
                              <KV
                                label={L.kv.shipmentDateFrom || "Date from"}
                                icon={CalendarIcon}
                              >
                              ...
                              <KV
                                label={L.kv.shipmentDateTo || "Date to"}
                                icon={CalendarIcon}
                              >
                              ...
                              <KV
                                label={L.kv.shipmentQuantity || "Quantity"}
                                icon={Hash}
                              >
                                {d.shipmentQuantity != null
                                  ? fmtDOT(d.shipmentQuantity, 3)
                                  : "—"}
                              </KV>
                            </Section>
                          ...
                          >
                            <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-3 text-xs text-slate-700">
                              ...
                              <Section title="Header">
                                ...
                                <KV
                                  label={
                                    L.kv.validUntilDay || "Valid until day"
                                  }
                                  icon={CalendarIcon}
                                >
                                  {formatDate(d.validUntilDay, locale, "—")}
...
function DocForm({ initial, onCancel, onSaved, showNotice }) {
  ...
  return (
    <form onSubmit={save} className="space-y-4">
      ...
      {tab === "location" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <Field label={F.pickLocation || "Pick Location"} icon={IdCard}>
            <LocationCombobox
              valueNo={loc.no}
...
{tab === "shipment" && (
  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
    ...
    <Field label={F.shipmentDateFrom || "Shipment date from"} icon={CalendarIcon}>
      <input
        type="date"
        className={INPUT_CLS}
    ...
    <Field label={F.shipmentDateTo || "Shipment date to"} icon={CalendarIcon}>
      <input
        type="date"
        className={INPUT_CLS}
    ...
    <Field label={F.shipmentQuantity || "Shipment quantity"} icon={Hash}>
      <input
        type="number"
        step="0.001"
        className={INPUT_CLS}
